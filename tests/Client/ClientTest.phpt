...
$mockedHandler = new MockHandler([
	...
	new Response(200, [], '{"access_token":"123123123","refresh_token":"321321321321321","scope":["read_homecoach"],"expires_in":10800,"expire_in":10800}'),
	new Response(200, [], '{"access_token":"123456789123456789123456","scope":["read_homecoach"],"expires_in":10800,"expire_in":10800}'),
	new Response(300, [], '{"access_token":"123456789123456789123456","scope":["read_homecoach"],"expires_in":10800,"expire_in":10800}'),
	...
	new ClientException('Error test', new Request('GET', 'test'), new Response(403)),
	new Response(200, [], '{"access_token":"123456789123456789","refresh_token":"123456789123456789321321321","scope":["read_homecoach"],"expires_in":10800,"expire_in":10800}'),
...
Assert::exception(function () use ($client, $authorizationRequest) {
...
Assert::exception(function () use ($client, $healthyHomeCoachDataRequest) {
